...
public class SudokuTrainer
{
    public static BufferedImage sudokuSquare;

    public static void main(String[] args) throws IOException
    {
        String[] urls = { /*"http://www.thenewspaper.org.uk/images/sudoku38.jpg",
                "http://www.thenewspaper.org.uk/images/sudoku41.jpg",
                "http://www.thenewspaper.org.uk/images/sudoku45.jpg",
                "http://www.conceptispuzzles.com/picture/12/695.jpg",
                "http://www.counton.org/thesum/issue-15/images/easy1.png",
                "http://img.brothersoft.com/icon/softimage/s/sudoku_puzzle_game_and_solver-38531.jpeg"*/
                "http://www.thenewspaper.org.uk/images/sudoku42.jpg",
                "http://www.thenewspaper.org.uk/images/sudoku43.jpg",
                };
        String destinationFile = "image.jpg";
        for (String url : urls)
        {
            saveImage(url, destinationFile);
            recognizeSudoku(destinationFile);
        }
    }
    ...
    public static String recognizeSudoku(String filename)
    {
        ...
        sudokuSquare = Mat2BufferedImage(undistorted);

        return identifyCellsAndDigits(maxLength, undistortedThreshed);
    }

    private static String identifyCellsAndDigits(int maxLength, Mat undistortedThreshed)
    {
        ...
        for (int j = 0; j < 9; j++)
        {
            for (int i = 0; i < 9; i++)
            {
                ...
                if (maxBounds.area > 100)
                {
                    ...
                    Mat mat = new DigitIdentifier().preprocessImage(currentCell, maxBounds);
                    int number = scan.nextInt();

                    try
                    {
                        String filename = "training_data.dat";
        ...
        for (JFrame frame : SudokuRecognizer.frames)
